...
export const NavAbout = () => {
    ...
    const media2XlBTN = `py-4 px-14  text-white border border-white bg-[#1b1b1b] cursor-pointer shadow-custom
                ...
                {navigation.map((ruta, index) => {
                    return (       
                        <Link
                            ...
                            className={`2xl:${media2XlBTN} xl:${mediaXL}` }
                        >
                            {ruta.name}
                        </Link>
                    );
